...
[AddComponentMenu("Layout/Custom Layout Group 2", 153)]
public class CustomLayoutGroup2 : LayoutGroup
{
    ...
    [SerializeField] protected bool m_Horizontal = false;
    ...
    {
        get { return rectTransform.rect.width - padding.horizontal + spacing.x; }
    }
    ...
    {
        RectTransform layout = gameObject.GetComponent<RectTransform>();
